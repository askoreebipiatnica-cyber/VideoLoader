...
## Как скачать рилс (4 шага)
1. Запусти помощника: дважды кликни `tools\helper\run-helper.bat` (появится «помощник вкл» внизу окна).
2. Вставь ссылку рилса в строку.
3. Жми **«Скачать»** — в статусе видно этапы.
4. Файл в загрузках. Смотри гифку выше.
